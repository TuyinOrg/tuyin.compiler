...
namespace libtui
{
    ...
    class ComputeParticlesApp : VulkanApp
    {
        ...
        protected override void InitializePermanent()
        {
            ...
            _particleDiffuseMap          = Content.Load<VulkanImage>("resources/test/ParticleDiffuse.ktx");
        ...
        {
            _depthStencil     = ToDispose(VulkanImage.DepthStencil(Context, Window.Width, Window.Height));
        ...
        private VulkanBuffer CreateStorageBuffer()
        {
            ...
            int numParticles = Window.Platform == Platform.Linux
                ? 256 * 1024
        ...
        private Pipeline CreateGraphicsPipeline()
        {
            ...
            {
                new PipelineShaderStageCreateInfo(ShaderStages.Vertex, Content.Load<ShaderModule>("resources/test/shader.vert.spv"), "main"),
                new PipelineShaderStageCreateInfo(ShaderStages.Fragment, Content.Load<ShaderModule>("resources/test/shader.frag.spv"), "main"),
            };
        ...
        private Pipeline CreateComputePipeline()
        {
            var pipelineCreateInfo = new ComputePipelineCreateInfo(
                new PipelineShaderStageCreateInfo(ShaderStages.Compute, Content.Load<ShaderModule>("resources/test/shader.comp.spv"), "main"),
