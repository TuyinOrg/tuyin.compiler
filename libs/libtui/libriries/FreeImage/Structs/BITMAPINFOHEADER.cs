...
namespace FreeImage
{
	...
	/// </summary>
	/// <remarks>
	/// The <see cref="compute.environment.imaging.BITMAPINFO"/> structure combines the
	...
	public struct BITMAPINFOHEADER : IEquatable<BITMAPINFOHEADER>
	{
		...
		/// <term>1</term>
		/// <description>
		/// The bitmap is monochrome, and the bmiColors member of <see cref="compute.environment.imaging.BITMAPINFO"/>
