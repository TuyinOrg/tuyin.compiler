...
namespace FreeImage
{
	...
	{
		/// <summary>
		/// Specifies a <see cref="compute.environment.imaging.BITMAPINFOHEADER"/> structure that contains information
		...
		/// <item>
		/// <term>
		/// An array of <see cref="compute.environment.imaging.RGBQUAD"/>. The elements of the array that make up the
		/// color table.
		/// </term>
		/// </item>
		/// 
		...
		/// <b>biClrUsed</b> members of the <see cref="compute.environment.imaging.BITMAPINFOHEADER"/> structure.
		/// <para/>
