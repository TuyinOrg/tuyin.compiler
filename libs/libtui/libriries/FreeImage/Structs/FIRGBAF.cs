...
namespace FreeImage
{
    ...
    /// <para>
    /// The same conversion is also applied when the <see cref="compute.environment.imaging.FIRGBAF.Color"/>
    /// property or the <see cref="compute.environment.imaging.FIRGBAF(System.Drawing.Color)"/> constructor
    /// is invoked.
    /// </para>
    /// </remarks>
    /// <example>
