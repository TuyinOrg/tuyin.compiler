...
namespace FreeImage
{
    ...
    /// <para>
    /// The same conversion is also applied when the <see cref="compute.environment.imaging.RGBQUAD.Color"/>
    /// property or the <see cref="compute.environment.imaging.RGBQUAD(System.Drawing.Color)"/> constructor
    /// is invoked.
    /// </para>
    /// </remarks>
    /// <example>
	...
	public struct RGBQUAD : IComparable, IComparable<RGBQUAD>, IEquatable<RGBQUAD>
	{
		...
		{
			return this.Color.PackedValue.CompareTo(other.Color.PackedValue);
		}
