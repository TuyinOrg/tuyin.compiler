...
namespace FreeImage
{
    ...
    /// <para>
    /// The same conversion is also applied when the <see cref="compute.environment.imaging.RGBTRIPLE.Color"/>
    /// property or the <see cref="compute.environment.imaging.RGBTRIPLE(System.Drawing.Color)"/> constructor
    /// is invoked.
    /// </para>
    /// </remarks>
    /// <example>
