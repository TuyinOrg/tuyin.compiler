...
namespace GLFW
{
    ...
    internal delegate void ErrorCallback(ErrorCode code, IntPtr message);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void PositionCallback(Window window, double x, double y);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void FocusCallback(Window window, bool focusing);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void FileDropCallback(Window window, int count, IntPtr arrayPtr);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void MouseButtonCallback(Window window, MouseButtons button, InputState state,
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void CharCallback(Window window, uint codePoint);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void CharModsCallback(Window window, uint codePoint, ModifierKeys mods);
    ...
    /// <param name="mods">	Bit field describing which modifier keys were held down.</param>
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void KeyCallback(Window window, Keys key, int scanCode, InputState state, ModifierKeys mods);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void JoystickCallback(Joystick joystick, ConnectionStatus status);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void IconifyCallback(IntPtr window, bool focusing);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void WindowContentsScaleCallback(Window window, float xScale, float yScale);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    internal delegate void WindowMaximizedCallback(Window window, bool maximized);
}