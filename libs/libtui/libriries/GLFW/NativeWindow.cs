...
namespace GLFW
{
    ...
    internal class NativeWindow : SafeHandleZeroOrMinusOneIsInvalid, IEquatable<NativeWindow>
    {
        /// <summary>
        ...
        /// </summary>
        protected internal Window Window => mWindow;

        private Size mInitializeSize;
        private bool mIsInitialized;
        private Window mWindow;
        private string mTitle;
        private Monitor mMonitor;
        private Window mShare;
        ...
        /// </summary>
        internal NativeWindow() : this(800, 600, string.Empty, Monitor.None, Window.None)
        {
        }
        ...
        {
            mTitle = title ?? string.Empty;
            mMonitor = monitor;
            mShare = share;
            mIsInitialized = false;
            mInitializeSize = new Size(width, height);
        }
        ...
        {
            mWindow = Glfw.CreateWindow(mInitializeSize.Width, mInitializeSize.Height, mTitle ?? string.Empty, mMonitor, mShare);
            SetHandle(Window);
        ...
        /// </summary>
        public event EventHandler<MouseEventArgs> MouseButton;
        ...
        private ModifierKeys mModifiers;
        private double mMouseX;
        private double mMouseY;
        private int mMouseDelta;
        ...
        protected virtual void OnMouseButton(MouseButtons button, InputState state, ModifierKeys modifiers)
        {
            mState = state;
            mMouseButton = button;
            mModifiers = modifiers;
            MouseButton?.Invoke(this, new MouseEventArgs(mMouseX, mMouseY, mMouseDelta, state, button, modifiers, null, default));
        }
        ...
        {
            var e = new MouseEventArgs(mMouseX, mMouseY, mMouseDelta, mState, mMouseButton, mModifiers, null, default);
            if (entering)
        ...
        protected virtual void OnMouseMove(double x, double y)
        {
            mMouseX = x;
            mMouseY = y;
            MouseMoved?.Invoke(this, new MouseEventArgs(x, y, mMouseDelta, mState, mMouseButton, mModifiers, null, default));
        }
        ...
        {
            mMouseDelta = (int)(x * y);
            MouseScroll?.Invoke(this, new MouseEventArgs(mMouseX, mMouseY, mMouseDelta, mState, mMouseButton, mModifiers, null, default));
        }
