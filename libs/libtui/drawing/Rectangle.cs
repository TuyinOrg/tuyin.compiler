...
namespace libtui.drawing
{
    ...
    public struct Rectangle : IEquatable<Rectangle>, IGeometry
    {
        ...
        public IEnumerable<GeometryData> GetGeometryDatas()
        {
            ...
            points[0] = new GeometryPoint(0, LeftTop.ToPointF(), 0);
            points[1] = new GeometryPoint(1, RightTop.ToPointF(), 0);
            points[2] = new GeometryPoint(2, RightBottom.ToPointF(), 0);
            points[3] = new GeometryPoint(3, LeftBottom.ToPointF(), 0);
