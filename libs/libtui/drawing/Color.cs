...
namespace libtui.drawing
{
    ...
    public struct Color : IEquatable<Color>
    {
        ...
        {
            return new Color(Convert.ToUInt32(argb));
        }
        ...
        public int ToArgb()
        {
            return unchecked((int)PackedValue);
        }
        ...
        public Color(Color color, int alpha)
        {
            ...
            {
                var clampedA = (uint)Clamp(alpha, Byte.MinValue, Byte.MaxValue);
        ...
        public Color(int r, int g, int b)
        {
            ...
            {
                var clampedR = (uint)Clamp(r, Byte.MinValue, Byte.MaxValue);
                var clampedG = (uint)Clamp(g, Byte.MinValue, Byte.MaxValue);
                var clampedB = (uint)Clamp(b, Byte.MinValue, Byte.MaxValue);
        ...
        public static Color White
    {
        ...
        public static Color LerpPrecise(Color value1, Color value2, Single amount)
        {
            amount = Clamp(amount, 0, 1);
            return new Color(
                (int)LerpPrecise(value1.R, value2.R, amount),
                (int)LerpPrecise(value1.G, value2.G, amount),
                (int)LerpPrecise(value1.B, value2.B, amount),
                (int)LerpPrecise(value1.A, value2.A, amount));
        }
	...
	/// <summary>
        ...
        /// </remarks>
        private static float LerpPrecise(float value1, float value2, float amount)
        {
