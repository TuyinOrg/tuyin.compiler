...
{
    abstract class VulkanApp : IDisposable
    {
        ...
        public void Initialize(Window window)
        {
            ...
            Context = ToDispose(new VulkanContext(Instance, Surface, Window.Platform));
            Content = ToDispose(new ContentManager(Window, Context));
            ...
            if (window.Platform == Platform.MacOS)
            {
        ...
        private Instance CreateInstance(bool debug)
        {
            ...
            if (debug && Window.Platform != Platform.MacOS)
            {
        ...
        {
            //Currently MoltenVK (used for MacOS) doesn't support the debug layer.
            if (!debug || Window.Platform == Platform.MacOS) return null;
        ...
        private SurfaceKhr CreateSurface()
        {
            ...
            {
                case Platform.Linux:
                    return Instance.CreateAndroidSurfaceKhr(new AndroidSurfaceCreateInfoKhr(Window.WindowHandle));
                case Platform.Win32:
                    return Instance.CreateWin32SurfaceKhr(new Win32SurfaceCreateInfoKhr(Window.InstanceHandle, Window.WindowHandle));
                case Platform.MacOS:
                    return Instance.CreateMacOSSurfaceMvk(new MacOSSurfaceCreateInfoMvk(Window.WindowHandle));
                default:
                    throw new NotImplementedException();
            }
        }
        ...
        protected void RecordCommandBuffers()
        {
