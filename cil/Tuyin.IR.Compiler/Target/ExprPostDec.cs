...
{
    internal class ExprPostDec : ExprRoot
    {
        private ExprRoot tmp_15_i;

        public override AstNodeType AstType => AstNodeType.ExprPostDec;

        internal ExprPostDec(SourceSpan sourceSpan, ExprRoot tmp_15_i)
            : base(sourceSpan)
        {
