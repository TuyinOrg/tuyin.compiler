...
using System;
using Buffer = compute.vulkan.Buffer;
...
namespace compute.environment
{
    internal class VulkanBuffer : IDisposable
    {
        ...
        public static VulkanBuffer DynamicUniform(VulkanContext ctx, long byteSize, int count)
        {
            long size = byteSize * count;
        ...
        public static VulkanBuffer DynamicUniform<T>(VulkanContext ctx, int count) where T : struct
        {
            ...
            return DynamicUniform(ctx, size, count);
        }
