...
namespace compute.environment.imaging.IO
{
	/// <summary>
	...
	{
		/// <summary>
		/// <see cref="compute.environment.imaging.IO.FreeImageIO"/> structure that can be used to read from streams via
		/// <see cref="compute.environment.imaging.FreeImage.LoadFromHandle(FREE_IMAGE_FORMAT, ref FreeImageIO, fi_handle, FREE_IMAGE_LOAD_FLAGS)"/>.
		/// </summary>
		public static readonly FreeImageIO io;

		/// <summary>
		/// Initializes a new instances which can be used to
		/// create a FreeImage compatible <see cref="compute.environment.imaging.IO.FreeImageIO"/> structure.
		/// </summary>
