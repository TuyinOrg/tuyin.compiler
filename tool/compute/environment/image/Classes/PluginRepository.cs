...
namespace compute.environment.imaging.Plugins
{
	/// <summary>
	/// Class representing all registered <see cref="compute.environment.imaging.Plugins.FreeImagePlugin"/> in FreeImage.
	/// </summary>
	static class PluginRepository
	{
		...
		/// <summary>
		/// Returns an instance of <see cref="compute.environment.imaging.Plugins.FreeImagePlugin"/>, representing the given format.
		/// </summary>
		/// <param name="fif">The representing format.</param>
		/// <returns>An instance of <see cref="compute.environment.imaging.Plugins.FreeImagePlugin"/>.</returns>
		...
		/// <summary>
		/// Returns an instance of <see cref="compute.environment.imaging.Plugins.FreeImagePlugin"/>,
		...
		/// <summary>
		/// Returns an instance of <see cref="compute.environment.imaging.Plugins.FreeImagePlugin"/> for the given format.
		/// </summary>
		...
		/// <summary>
		/// Returns an instance of <see cref="compute.environment.imaging.Plugins.FreeImagePlugin"/> for the given filename.
		/// </summary>
		...
		/// <summary>
		/// Returns an instance of <see cref="compute.environment.imaging.Plugins.FreeImagePlugin"/> for the given mime.
		/// </summary>
