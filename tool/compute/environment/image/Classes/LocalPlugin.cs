...
namespace compute.environment.imaging.Plugins
{
	...
	/// <see cref="compute.environment.imaging.Plugins.LocalPlugin.GetImplementedMethods"/> and
	/// <see cref="compute.environment.imaging.Plugins.LocalPlugin.FormatProc"/>.
	/// <see cref="compute.environment.imaging.Plugins.LocalPlugin.GetImplementedMethods"/> is used by the constructor
	...
	/// <see cref="compute.environment.imaging.Plugins.LocalPlugin.MethodFlags"/>.
	/// <para/>
	/// For example:
	...
	/// <see cref="compute.environment.imaging.Plugins.LocalPlugin.GetImplementedMethods"/> without a real implementation.
	/// <para/>
	/// <see cref="compute.environment.imaging.Plugins.LocalPlugin.FormatProc"/> is used by some checks of FreeImage and
	/// must be implemented. <see cref="compute.environment.imaging.Plugins.LocalPlugin.LoadProc"/> for example can be
