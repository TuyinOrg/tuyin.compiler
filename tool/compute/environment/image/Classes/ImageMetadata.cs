...
namespace compute.environment.imaging.Metadata
{
	/// <summary>
	/// Class handling metadata of a FreeImage bitmap.
	/// </summary>
	class ImageMetadata : IEnumerable, IComparable, IComparable<ImageMetadata>
	{
		...
		/// <returns>The <see cref="compute.environment.imaging.Metadata.MetadataModel"/> object of the specified type.</returns>
		...
		/// <summary>
		/// Gets or sets the <see cref="compute.environment.imaging.Metadata.MetadataModel"/> at the specified index.
		/// <para>In case the getter returns <c>null</c> the model is not contained
		/// by the list.</para>
		/// <para><c>null</c> can be used calling the setter to destroy the model.</para>
		/// </summary>
		/// <param name="index">Index of the <see cref="compute.environment.imaging.Metadata.MetadataModel"/> within
		/// this instance.</param>
		/// <returns>The <see cref="compute.environment.imaging.Metadata.MetadataModel"/>
		...
		/// <see cref="compute.environment.imaging.Metadata.MetadataModel">MetadataModels</see>.
		/// </summary>
		...
		/// <see cref="compute.environment.imaging.Metadata.MetadataTag.Key"/> will be used as key.
		/// </summary>
		...
		/// <see cref="compute.environment.imaging.Metadata.MetadataModel">MetadataModels</see> are hidden.
		/// </summary>
