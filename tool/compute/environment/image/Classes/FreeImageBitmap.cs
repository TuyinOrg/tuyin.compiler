...
using compute.environment.imaging.Metadata;
...
namespace compute.environment.imaging
{
	...
	class FreeImageBitmap : IDisposable, IEnumerable
#endif
	{
#region Fields
...
#region Constructors and Destructor
		...
		public FreeImageBitmap(Type type, string resource)
			: this(FreeImage.GetAssembly(type).GetManifestResourceStream(resource))
		{
		}
...
#region Methods
		...
		public FreeImageBitmap GetThumbnailImage(int thumbWidth, int thumbHeight,
			Func<bool> callback, IntPtr callBackData)
		{
			EnsureNotDisposed();
