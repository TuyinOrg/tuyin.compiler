...
namespace compute.environment.imaging
{
	...
	/// <para>
	/// The same conversion is also applied when the <see cref="compute.environment.imaging.FIRGB16.Color"/>
	/// property or the <see cref="compute.environment.imaging.FIRGB16(System.Drawing.Color)"/> constructor
	/// is invoked.
	/// </para>
	/// </remarks>
	/// <example>
