...
namespace compute.vulkan.khx
{
    ...
    unsafe struct DeviceGroupPresentCapabilitiesKhx
    {
    ...
    /// </summary>
    [Flags]
    enum DeviceGroupPresentModesKhx
    {
        /// <summary>
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    unsafe struct DeviceGroupDeviceCreateInfoKhx
    {
        /// <summary>
        /// The type of this structure.
        /// </summary>
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    unsafe struct DeviceGroupPresentInfoKhx
    {
        /// <summary>
        /// The type of this structure.
        /// </summary>
