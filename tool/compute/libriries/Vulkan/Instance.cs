...
namespace compute.vulkan
{
    ...
    /// </para>
    /// </summary>
    unsafe class Instance : DisposableHandle<IntPtr>
    {
    ...
    /// </summary>
    unsafe struct InstanceCreateInfo
    {
        /// <summary>
    ...
    /// </summary>
    unsafe struct ExtensionProperties
    {
        /// <summary>
