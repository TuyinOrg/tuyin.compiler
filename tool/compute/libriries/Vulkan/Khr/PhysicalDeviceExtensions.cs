...
using static compute.vulkan.Constant;

namespace compute.vulkan.khr
{
    /// <summary>
    /// Provides Khronos specific extension methods for the <see cref="PhysicalDevice"/> class.
    /// </summary>
    static unsafe class PhysicalDeviceExtensions
    {
        /// <summary>
    ...
    /// </summary>
    unsafe struct DisplayPropertiesKhr
    {
        /// <summary>
    ...
    /// </summary>
    [Flags]
    enum ExternalMemoryHandleTypesKhr
    {
        /// <summary>
    ...
    /// </summary>
    [Flags]
    enum ExternalMemoryFeaturesKhr
    {
        /// <summary>
    ...
    /// </summary>
    [Flags]
    enum ExternalSemaphoreFeaturesKhr
    {
        /// <summary>
    ...
    /// </summary>
    [Flags]
    enum ExternalFenceHandleTypeFlagsKhr
    {
        /// <summary>
    ...
    /// </summary>
    [Flags]
    enum ExternalFenceFeatureFlagsKhr
    {
        /// <summary>
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    unsafe struct PhysicalDeviceIdPropertiesKhr
    {
        internal StructureType Type;
