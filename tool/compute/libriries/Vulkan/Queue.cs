...
namespace compute.vulkan
{
    ...
    /// </summary>
    unsafe class Queue : VulkanHandle<IntPtr>
    {
    ...
    /// </summary>
    unsafe struct SparseBufferMemoryBindInfo
    {
        /// <summary>
    ...
    /// </summary>
    unsafe struct SparseImageOpaqueMemoryBindInfo
    {
        /// <summary>
    ...
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
    unsafe struct SparseImageMemoryBindInfo
    {
        /// <summary>
        /// The <see cref="VulkanCore.Image"/> object to be bound.
        /// </summary>
