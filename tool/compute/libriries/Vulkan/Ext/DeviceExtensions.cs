...
using static compute.vulkan.ext.DeviceExtensions;

namespace compute.vulkan.ext
{
    /// <summary>
    ...
    /// </summary>
    unsafe struct DebugMarkerObjectNameInfoExt
    {
        /// <summary>
    ...
    /// </summary>
    unsafe struct DebugMarkerObjectTagInfoExt
    {
        /// <summary>
