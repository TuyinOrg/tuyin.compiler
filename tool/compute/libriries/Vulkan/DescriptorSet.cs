...
namespace compute.vulkan
{
    ...
    /// </summary>
    unsafe class DescriptorSet : DisposableHandle<long>
    {
    ...
    /// </summary>
    unsafe struct DescriptorSetAllocateInfo
    {
        /// <summary>
    ...
    /// </summary>
    unsafe struct WriteDescriptorSet
    {
        /// <summary>
    ...
    struct DescriptorImageInfo
    {
        ...
        public DescriptorImageInfo(Sampler sampler, Image image, ImageLayout imageLayout)
        {
            Sampler = sampler;
            ImageView = image;
            ImageLayout = imageLayout;
