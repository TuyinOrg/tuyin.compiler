...
namespace compute.vulkan
{
    ...
    abstract class VulkanHandle<THandle> where THandle : struct
    {
        /// <summary>
    ...
    /// </summary>
    /// <typeparam name="THandle">Handle type.</typeparam>
    abstract unsafe class DisposableHandle<THandle> : VulkanHandle<THandle>, IDisposable
    ...
    /// </summary>
    static class VulkanHandleExtensions
    {
