...
namespace OpenCL.Extensions
{
    /// <summary>
    /// Contains extension methods using OpenCL
    /// </summary>
    static class OpenCLExtensions
    {
        /// <summary>
        ...
        public static void OpenCLForEach<TSource>(this TSource[] array, string kernelCode, Func<string, bool> kernelSelector = null, Func<int, string, Version, bool> deviceSelector = null) where TSource : struct
        {
