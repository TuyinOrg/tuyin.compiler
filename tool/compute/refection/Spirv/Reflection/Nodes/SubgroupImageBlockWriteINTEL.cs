...
{
    internal partial class SubgroupImageBlockWriteINTEL : ExecutableNode, INodeWithNext
    {
    ...
    {
        internal static SubgroupImageBlockWriteINTEL ThenSubgroupImageBlockWriteINTEL(this INodeWithNext node, Node image, Node coordinate, Node data, string debugName = null)
        {
