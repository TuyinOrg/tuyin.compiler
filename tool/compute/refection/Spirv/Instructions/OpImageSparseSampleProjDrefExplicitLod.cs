...
{
    internal partial class OpImageSparseSampleProjDrefExplicitLod: InstructionWithId
    {
        public OpImageSparseSampleProjDrefExplicitLod()
        {
        }

        public override Op OpCode { get { return Op.OpImageSparseSampleProjDrefExplicitLod; } }
