...
{
    internal partial class OpSubgroupAvcBmeInitializeINTEL: InstructionWithId
    {
        public OpSubgroupAvcBmeInitializeINTEL()
        {
        }

        public override Op OpCode { get { return Op.OpSubgroupAvcBmeInitializeINTEL; } }
        ...
        {
            return $"{IdResultType} {IdResult} = {OpCode} {SrcCoord} {MotionVectors} {MajorShapes} {MinorShapes} {Direction} {PixelResolution} {BidirectionalWeight} {SadAdjustment}";
        }
    }
}
