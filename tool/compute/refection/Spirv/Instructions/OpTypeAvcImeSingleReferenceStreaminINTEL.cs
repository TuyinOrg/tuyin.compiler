...
{
    internal partial class OpTypeAvcImeSingleReferenceStreaminINTEL: TypeInstruction
    {
        public OpTypeAvcImeSingleReferenceStreaminINTEL()
        {
        }

        public override Op OpCode { get { return Op.OpTypeAvcImeSingleReferenceStreaminINTEL; } }
