...
{
    internal partial class OpCreatePipeFromPipeStorage: InstructionWithId
    {
        public OpCreatePipeFromPipeStorage()
        {
        }

        public override Op OpCode { get { return Op.OpCreatePipeFromPipeStorage; } }
        ...
        public Spv.IdRef PipeStorage { get; set; }
        ...
        {
            PipeStorage = Spv.IdRef.Parse(reader, end-reader.Position);
        }
        ...
        public override uint GetWordCount()
        {
            ...
            wordCount += PipeStorage.GetWordCount();
            return wordCount;
        }
        ...
        {
            return $"{IdResultType} {IdResult} = {OpCode} {PipeStorage}";
        }
    }
}
