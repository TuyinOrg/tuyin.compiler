...
{
    internal partial class OpSubgroupAvcMceSetSourceInterlacedFieldPolarityINTEL: InstructionWithId
    {
        public OpSubgroupAvcMceSetSourceInterlacedFieldPolarityINTEL()
        {
        }

        public override Op OpCode { get { return Op.OpSubgroupAvcMceSetSourceInterlacedFieldPolarityINTEL; } }
        ...
        public Spv.IdRef SourceFieldPolarity { get; set; }
        ...
        {
            SourceFieldPolarity = Spv.IdRef.Parse(reader, end-reader.Position);
        ...
        public override uint GetWordCount()
        {
            ...
            wordCount += SourceFieldPolarity.GetWordCount();
        ...
        {
            SourceFieldPolarity.Write(writer);
        ...
        {
            return $"{IdResultType} {IdResult} = {OpCode} {SourceFieldPolarity} {Payload}";
        }
    }
}
