...
{
    internal partial class OpTypeAvcImeDualReferenceStreaminINTEL: TypeInstruction
    {
        public OpTypeAvcImeDualReferenceStreaminINTEL()
        {
        }

        public override Op OpCode { get { return Op.OpTypeAvcImeDualReferenceStreaminINTEL; } }
