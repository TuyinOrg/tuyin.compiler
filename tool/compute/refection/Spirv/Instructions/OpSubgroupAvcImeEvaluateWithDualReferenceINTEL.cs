...
{
    internal partial class OpSubgroupAvcImeEvaluateWithDualReferenceINTEL: InstructionWithId
    {
        public OpSubgroupAvcImeEvaluateWithDualReferenceINTEL()
        {
        }

        public override Op OpCode { get { return Op.OpSubgroupAvcImeEvaluateWithDualReferenceINTEL; } }
