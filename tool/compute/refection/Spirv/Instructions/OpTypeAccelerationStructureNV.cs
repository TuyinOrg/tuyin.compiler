...
{
    internal partial class OpTypeAccelerationStructureNV: TypeInstruction
    {
        public OpTypeAccelerationStructureNV()
        {
        }

        public override Op OpCode { get { return Op.OpTypeAccelerationStructureNV; } }
