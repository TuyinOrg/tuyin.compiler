...
{
    internal partial class OpTypeRayQueryProvisionalKHR: TypeInstruction
    {
        public OpTypeRayQueryProvisionalKHR()
        {
        }

        public override Op OpCode { get { return Op.OpTypeRayQueryProvisionalKHR; } }
