...
{
    internal partial class OpSubgroupAvcSicEvaluateIpeINTEL: InstructionWithId
    {
        public OpSubgroupAvcSicEvaluateIpeINTEL()
        {
        }

        public override Op OpCode { get { return Op.OpSubgroupAvcSicEvaluateIpeINTEL; } }
        ...
        {
            return $"{IdResultType} {IdResult} = {OpCode} {SrcImage} {Payload}";
        }
    }
}
