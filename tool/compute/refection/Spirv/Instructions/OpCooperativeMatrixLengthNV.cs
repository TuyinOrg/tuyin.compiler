...
{
    internal partial class OpCooperativeMatrixLengthNV: InstructionWithId
    {
        public OpCooperativeMatrixLengthNV()
        {
        }

        public override Op OpCode { get { return Op.OpCooperativeMatrixLengthNV; } }
        ...
        {
            return $"{IdResultType} {IdResult} = {OpCode} {Type}";
        }
    }
}
