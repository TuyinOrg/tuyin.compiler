...
{
    internal partial class OpDemoteToHelperInvocationEXT: Instruction
    {
        public OpDemoteToHelperInvocationEXT()
        {
        }

        public override Op OpCode { get { return Op.OpDemoteToHelperInvocationEXT; } }
