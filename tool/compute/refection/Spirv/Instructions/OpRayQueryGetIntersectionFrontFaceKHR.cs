...
{
    internal partial class OpRayQueryGetIntersectionFrontFaceKHR: InstructionWithId
    {
        public OpRayQueryGetIntersectionFrontFaceKHR()
        {
        }

        public override Op OpCode { get { return Op.OpRayQueryGetIntersectionFrontFaceKHR; } }
