...
{
    internal partial class OpSubgroupAvcSicSetBlockBasedRawSkipSadINTEL: InstructionWithId
    {
        public OpSubgroupAvcSicSetBlockBasedRawSkipSadINTEL()
        {
        }

        public override Op OpCode { get { return Op.OpSubgroupAvcSicSetBlockBasedRawSkipSadINTEL; } }
        ...
        public Spv.IdRef BlockBasedSkipType { get; set; }
        ...
        {
            BlockBasedSkipType = Spv.IdRef.Parse(reader, end-reader.Position);
        ...
        public override uint GetWordCount()
        {
            ...
            wordCount += BlockBasedSkipType.GetWordCount();
        ...
        {
            BlockBasedSkipType.Write(writer);
        ...
        {
            return $"{IdResultType} {IdResult} = {OpCode} {BlockBasedSkipType} {Payload}";
        }
    }
}
