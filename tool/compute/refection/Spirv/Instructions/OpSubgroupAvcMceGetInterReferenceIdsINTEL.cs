...
{
    internal partial class OpSubgroupAvcMceGetInterReferenceIdsINTEL: InstructionWithId
    {
        public OpSubgroupAvcMceGetInterReferenceIdsINTEL()
        {
        }

        public override Op OpCode { get { return Op.OpSubgroupAvcMceGetInterReferenceIdsINTEL; } }
