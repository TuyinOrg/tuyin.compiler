...
namespace wasi.utils
{
    ...
    static unsafe class Interop
    {
        ...
        public static IntPtr ReAlloc(IntPtr original, Size size) =>
            Marshal.ReAllocHGlobal(original, (IntPtr)size);
        ...
        /// <summary>
        /// Copies bytes to the given location.
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="dstPointer">The location to copy to.</param>
        /// <param name="srcPointer">A pointer to the value to copy</param>
        /// <param name="byteCount">Copy count.</param>
        public static void Write(IntPtr dstPointer, IntPtr srcPointer, uint byteCount)
            => Unsafe.CopyBlock(dstPointer.ToPointer(), srcPointer.ToPointer(), byteCount);
