...
namespace GLFW
{
    internal static partial class Glfw
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]private delegate InputState GetMouseButtonDelegate0(Window window, MouseButton button);
        ...
        public static InputState GetMouseButton(Window window, MouseButton button) { return GetMouseButton0(window, button); }
