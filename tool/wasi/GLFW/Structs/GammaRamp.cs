...
namespace GLFW
{
    ...
    internal struct GammaRamp
    {
        ...
        internal unsafe GammaRampInternal ToInternal()
        {
            fixed (ushort* red = &Red[0], green = &Green[0], blue = &Blue[0])
            {
                return new GammaRampInternal((IntPtr)red, (IntPtr)green, (IntPtr)blue, Red.Length);
            }
        }
    }
}